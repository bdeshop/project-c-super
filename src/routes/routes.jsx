...
import Games from "../Pages/Games"; // Added Games import
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      }, // Render Referral as child of MainProfile
      {
        path: "/refferelbonus",
        element: (
          <ErrorBoundary>
      ...
      }, // Uncommented and wrapped with ErrorBoundary
      ...
      }, // Added referral code route with error boundary
